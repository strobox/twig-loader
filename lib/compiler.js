...
module.exports = function(options) {
    return function(id, tokens, pathToTwig) {
        ...
        var rendered = Twig.twig(opts).render({});
        var output = [
            'var React = require("react"), twig = require("twig").twig,',
            '   template = twig(' + JSON.stringify(opts) + ');\n',
            'module.exports = {react: function(props) { return '+rendered+' },',
            '                   render: function(context) { return template.render(context); } }'
        ];
